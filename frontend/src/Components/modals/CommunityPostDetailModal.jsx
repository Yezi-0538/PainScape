  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 2. 发布用户名片栏 (头像 + 昵称，点击跳转对方个人主页) */}
        <div
          onClick={() => {
            onViewProfile && onViewProfile(post.userId || post.authorId || "user_guest");
            onClose();
          }}
          style={{
            display: 'flex',
          ...
          {isEditingExp ? (
            <div>
              <textarea
                ...
                placeholder="填写你本次缓解疼痛的方法（例如：热水袋热敷下腹15分钟、喝红糖姜茶...确认后将汇入智慧货架）"
                style={{
                  width: '100%',
                  background: '#0a0a0a',
                  color: '#fff',
